...
suite0 = Suite('nwptsICON23').add(
   ...
   Variables(
      ...
      ECF_FILES='/home/mck/ec-tc/ecflow/nwp-ts/ecffiles.S23',
      ECF_INCLUDE= '/home/mck/ec-tc/ecflow/nwp-ts/include.S23',
      SCHOST= 'hpc',
      SCHOST_BKUP= 'hpc',
      WSHOST= 'hpc',
      USER= 'mck',
